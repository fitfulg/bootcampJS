...
exports.getAccount = exports.getmovementsList = void 0;
...
var url2 = "".concat("http://localhost:3000/api", "/account-list");
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/movements/movements.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapUsersListFromApiToVm = exports.mapMovementsListFromApiToVm = void 0;

var mapMovementsListFromApiToVm = function mapMovementsListFromApiToVm(movementsList) {
  return movementsList.map(function (account) {
    return mapMovementsFromApiToVm(account);
  });
};

exports.mapMovementsListFromApiToVm = mapMovementsListFromApiToVm;

var mapMovementsFromApiToVm = function mapMovementsFromApiToVm(movement) {
  return {
...
var mapUsersListFromApiToVm = function mapUsersListFromApiToVm(usersList) {
  return usersList.map(function (account) {
    return mapUsersFromApiToVm(account);
  });
};

exports.mapUsersListFromApiToVm = mapUsersListFromApiToVm;

var mapUsersFromApiToVm = function mapUsersFromApiToVm(account) {
  return {
...
},{}],"pages/movements/movements.helpers.js":[function(require,module,exports) {
"use strict";
...
var _movements2 = require("./movements.mappers");
...
if (isEditMode) {
  (0, _movements.getmovementsList)(params.id).then(function (apiMovement) {
    var movement = (0, _movements2.mapMovementsListFromApiToVm)(apiMovement);
    (0, _movements3.addMovementRows)(movement);
  });
  (0, _movements.getAccount)(params.id).then(function (response) {
    account = (0, _movements2.mapUsersListFromApiToVm)(response);
    (0, _element.onSetValues)(function (_ref) {
  ...
  (0, _movements.getmovementsList)().then(function (apiMovement) {
    var movement = (0, _movements2.mapMovementsListFromApiToVm)(apiMovement);
    (0, _movements3.addMovementRows)(movement);
  });
}
},{"./movements.api":"pages/movements/movements.api.js","../../core/router":"core/router/index.js","./movements.mappers":"pages/movements/movements.mappers.js","./movements.helpers":"pages/movements/movements.helpers.js","../../common/helpers/element.helpers":"common/helpers/element.helpers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
